#' Probability of Early Termination under a Two-Stage r-KJ BUDS
#'
#' Computes the approximate probability of early futility stopping at the
#' interim analysis for a restricted Kwak-Jung design evaluated at survival
#' probability \code{s} at time \code{x0}.
#'
